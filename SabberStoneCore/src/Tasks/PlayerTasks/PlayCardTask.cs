...
namespace SabberStoneCore.Tasks.PlayerTasks
{
	...
	{
		public static PlayCardTask Any(Controller controller, Playable source, Character target = null,
		...
		public static PlayCardTask Any(Controller controller, string cardName, Character target = null,
			int zonePosition = -1, int chooseOne = 0, bool skipPrePhase = false)
		{
		...
		public static PlayCardTask Minion(Controller controller, Playable source, int chooseOne = 0,
		...
		public static PlayCardTask MinionTarget(Controller controller, Playable source, Character target, int chooseOne = 0,
			bool skipPrePhase = false)
		{
			return new PlayCardTask(controller, source, target, -1, chooseOne, skipPrePhase);
		}
		public static PlayCardTask MinionTarget(Controller controller, string cardName, Character target, int chooseOne = 0,
			bool skipPrePhase = false)
		{
			return new PlayCardTask(controller, controller.HandZone.First(p => p.Card.Name == cardName), target, -1, chooseOne, skipPrePhase);
		}
		public static PlayCardTask Spell(Controller controller, Playable source, int chooseOne = 0,
			bool skipPrePhase = false)
		{
			return new PlayCardTask(controller, source, null, -1, chooseOne, skipPrePhase);
		}
		...
		public static PlayCardTask SpellTarget(Controller controller, Playable source, Character target, int chooseOne = 0,
			bool skipPrePhase = false)
		{
			return new PlayCardTask(controller, source, target, -1, chooseOne, skipPrePhase);
		}
		public static PlayCardTask SpellTarget(Controller controller, string cardName, Character target, int chooseOne = 0,
			bool skipPrePhase = false)
		{
			return new PlayCardTask(controller, controller.HandZone.First(p => p.Card.Name == cardName), target, -1, chooseOne, skipPrePhase);
		}
		public PlayCardTask(Controller controller, Playable source, Character target = null, int zonePosition = -1,
