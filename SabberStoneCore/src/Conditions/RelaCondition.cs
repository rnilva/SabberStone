...
{
	/// <summary>
	/// Container for all conditions about the relation between 2 <see cref="Playable"/>
	/// instances.
	/// </summary>
	public class RelaCondition
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
	{
		private readonly Func<Playable, Playable, bool> _function;
		...
		public static RelaCondition IsSameRace => new RelaCondition((me, other) => me.Card.Race == other.Card.Race);
		public static RelaCondition IsMyHeroAttacked => new RelaCondition((me, other) => other is Character && (me.Game.ProposedDefender == me.Controller.Hero.Id));
		...
		public RelaCondition(Func<Playable, Playable, bool> function)
		{
			_function = function;
		}

		public bool Eval(Playable owner, Playable affected)
		{
