...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
	{
		public static bool PlayCard(Game g, Controller c, Playable source, Character target = null, int zonePosition = -1, int chooseOne = 0, bool skipPrePhase = false)
		{
			...
			if (!skipPrePhase)
				if (!PrePlayPhase(g, c, source, target, zonePosition, chooseOne))
					return false;
			...
			{
				case Hero hero:
					PlayHero(g, c, hero, target, chooseOne);
					break;
				case Minion minion:
					PlayMinion(g, c, minion, target, zonePosition, chooseOne);
					break;
				case Weapon weapon:
					PlayWeapon(g, c, weapon, target, chooseOne);
					break;
				case Spell spell:
					PlaySpell(g, c, spell, target, chooseOne);
					break;
			}
		...
		public static bool PrePlayPhase(Game g, Controller c, Playable source, Character target, int zonePosition, int chooseOne)
		{
		...
		public static bool PayPhase(Game g, Controller c, Playable source)
		{
		...
		public static bool PlayHero(Game g, Controller c, Hero hero, Character target, int chooseOne)
		{
		...
		public static bool PlayMinion(Game g, Controller c, Minion minion, Character target, int zonePosition, int chooseOne)
		{
			...
			// - OnPlay Phase --> OnPlay Trigger (Illidan)
			//   (death processing, aura updates)
			triggerManager.OnPlayMinionTrigger(minion);
		...
		public static bool PlaySpell(Game g, Controller c, Spell spell, Character target, int chooseOne)
		{
			...
			// - OnPlay Phase --> OnPlay Trigger (Illidan)
			//   (death processing, aura updates)
			triggerManager.OnCastSpellTrigger(spell);
			...
			triggerManager.OnAfterCastTrigger(spell);
		...
		public static bool PlayWeapon(Game g, Controller c, Weapon weapon, Character target, int chooseOne)
		{
