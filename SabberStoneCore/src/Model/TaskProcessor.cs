...
namespace SabberStoneCore.Model
{
	public class TaskQueue
	{
		private class TaskInstance
		{
			...
			public readonly Playable Target;

			public TaskInstance(in ISimpleTask task, in Controller controller, in Entity source, in Playable target)
			{
				Task = task;
			...
			public static implicit operator (ISimpleTask, Controller, Entity, Playable) (TaskInstance t)
			{
				return (t.Task, t.Controller, t.Source, t.Target);
			}

			public void Deconstruct(out ISimpleTask simpleTask, out Controller controller, out Entity entity, out Playable target)
			{
				simpleTask = Task;
				controller = Controller;
				entity = Source;
		...
		public void EnqueueBase(in ISimpleTask task, in Controller controller, in Entity source, in Playable target)
		{
		...
		{
			(ISimpleTask task, Controller controller, Entity source, Playable target) = CurrentQueue.Peek();
