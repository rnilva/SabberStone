...
namespace SabberStoneCore.Model.Entities
{
	...
	public partial class Entity : IEntity
	{
		...
		/// <autogeneratedoc />
		protected internal Entity(in Game game, in Card card, in IDictionary<GameTag, int> tags)
		{
			Game = game;
		...
		internal Entity(in Game game, in EntityData data)
		{
			Game = game;
			_data = data;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
	...
	public partial class Entity
	{
		...
		/// A simple container for saving tag value perturbations from external Auras. Call indexer to get value for a particular Tag.
		/// </summary>
		public AuraEffects AuraEffects { get; }
