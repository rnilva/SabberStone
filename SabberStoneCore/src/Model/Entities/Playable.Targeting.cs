...
namespace SabberStoneCore.Model.Entities
{
	public abstract partial class Playable
	{
		...
		/// <value>
		/// <see cref="T:SabberStoneCore.Model.Entities.Character" />
		/// </value>
		/// <autogeneratedoc />
		public IEnumerable<Character> ValidPlayTargets => GetValidPlayTargets();
		...
		/// </returns>
		/// <autogeneratedoc />
		public virtual bool IsValidPlayTarget(Character target)
		{
			if (target == null)
			{
		...
		private List<Character> GetValidPlayTargets()
		{
		...
		public bool HasAnyValidPlayTargets
		{
			get
			{
				...
				if (friendlyMinions)
				{
					ReadOnlySpan<MinionInPlay> span = Controller.BoardZone.GetSpan();
		...
		//	//			{
		//	//				Playable[] dragons = Controller.HandZone.GetAll(p => p.Card.IsRace(Race.DRAGON));
