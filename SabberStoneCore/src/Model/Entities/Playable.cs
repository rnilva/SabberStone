...
namespace SabberStoneCore.Model.Entities
{
	...
	public abstract partial class Playable : Entity
	{
		...
		/// <autogeneratedoc />
		protected Playable(in Controller controller, in Card card, in int id)
			: base(controller.Game, in card, in id)
		{
		...
		protected Playable(in Controller controller, in Playable playable) : base(controller.Game, playable)
		{
			...
			_creatorId = playable._creatorId;
			_echoEffects = playable._echoEffects;
			_ghostly = playable._ghostly;
		}
		...
		public bool IsPlayableByCardReq()
		{
			...
			if (!Card.IsPlayableByCardReq(Controller))
			{
				if (_logging)
				{
					foreach (KeyValuePair<PlayReq, int> item in Card.PlayRequirements)
					{
						...
						Game.Log(LogLevel.DEBUG, BlockType.PLAY, "Playable",
							!Game.Logging ? "" : $"{this} check PlayReq {req} ... !");
						...
						switch (req)
						{
							case PlayReq.REQ_NUM_MINION_SLOTS:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"Board is full can't summon new minion.");
									return false;
								}
							...
							case PlayReq.REQ_ENTIRE_ENTOURAGE_NOT_IN_PLAY:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"All ready all entourageing cards summoned.");
									return false;
								}
							...
							case PlayReq.REQ_WEAPON_EQUIPPED:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"Need a weapon to play this card.");
									return false;
								}
							...
							case PlayReq.REQ_MINIMUM_ENEMY_MINIONS:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"Need at least {param} enemy minions to play this card.");
									return false;
								}
							...
							case PlayReq.REQ_MINIMUM_TOTAL_MINIONS:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"Need at least {param} minions to play this card.");
									return false;
								}
							...
							case PlayReq.REQ_STEADY_SHOT:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"Need steady shoot to be used.");
									return false;
								}
							...
							case PlayReq.REQ_FRIENDLY_MINION_DIED_THIS_GAME:
							{
								...
								{
									Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
										!Game.Logging ? "" : $"No friendly minions died this game.");
									return false;
								}
							...
							default:
								Game.Log(LogLevel.ERROR, BlockType.PLAY, "Playable",
									!Game.Logging ? "" : $"PlayReq {req} not in switch needs to be added (Playable)!");
								break;
						}
					}
				}
			...
			{
				Game.Log(LogLevel.VERBOSE, BlockType.PLAY, "Playable",
					!Game.Logging ? "" : $"{this} isn't playable, because need valid target and we don't have one.");
				return false;
			}
