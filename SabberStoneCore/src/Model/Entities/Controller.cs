...
namespace SabberStoneCore.Model.Entities
{
	...
	public partial class Controller : Entity
	{
		...
		/// </summary>
		public readonly ControlledZones ControlledZones;
		...
		/// </summary>
		public readonly GraveyardZone GraveyardZone;
		...
		/// </summary>
		public readonly SetasideZone SetasideZone;
		...
		public Controller(Game game, string name, int playerId, int id)
			: base(game,
			new EntityData(Card.CardPlayer, 64)
			{
