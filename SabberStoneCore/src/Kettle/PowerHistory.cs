	...
	public class PowerHistoryBuilder
	{
		public static PowerHistoryCreateGame CreateGame(Game game, Controller[] players)
		{
			return new PowerHistoryCreateGame()
			{
				...
				{
					Id = game.Id,
					Tags = new Dictionary<GameTag, int>(((Entity)game)._data)
				},
				Players = new PowerPlayer[]
					...
					new PowerPlayer
					{
						...
						{
							Id = players[0].Id,
							Tags = new Dictionary<GameTag, int>(((Entity)players[0])._data)
						}
					},
					new PowerPlayer
					{
						...
						{
							Id = players[1].Id,
							Tags = new Dictionary<GameTag, int>(((Entity)players[1])._data)
						}
					},
						}
			};
