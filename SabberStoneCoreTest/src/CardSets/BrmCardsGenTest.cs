...
namespace SabberStoneCoreTest.CardSets
{
	...
	public class HeroPowersBrmTest
	{
		...
		public void DieInsects_BRM_027pH()
		{
			...
			var testCard = (Character) Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Majordomo Executus"));
	...
	public class DruidBrmTest
	{
		...
		public void VolcanicLumberer_BRM_009()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Volcanic Lumberer"));
		...
		public void DruidOfTheFlame_BRM_010()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Druid of the Flame"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard1, 1));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Druid of the Flame"));
	...
	public class HunterBrmTest
	{
		...
		public void QuickShot_BRM_013()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Quick Shot"));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Quick Shot"));
		...
		public void CoreRager_BRM_014()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Core Rager"));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Core Rager"));
	...
	public class MageBrmTest
	{
		...
		public void DragonsBreath_BRM_003()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			//Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Dragon's Breath"));
			//Playable minion = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stonetusk Boar"));
			//game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion));
			//Assert.Equal(1, testCard.OldEnchants.Count);
		...
		public void Flamewaker_BRM_002()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Flamewaker"));
	...
	public class PaladinBrmTest
	{
		...
		public void SolemnVigil_BRM_001()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Solemn Vigil"));
	...
	public class PriestBrmTest
	{
		...
		public void Resurrect_BRM_017()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Resurrect"));
		...
		public void TwilightWhelp_BRM_004()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Twilight Whelp"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard1));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Twilight Whelp"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard2));
	...
	public class RogueBrmTest
	{
		...
		public void GangUp_BRM_007()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Gang Up"));
	...
	public class ShamanBrmTest
	{
		...
		public void LavaShock_BRM_011()
		{
			...
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Lava Shock"));
			Playable spell = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Ancestral Knowledge"));
		...
		public void FireguardDestroyer_BRM_012()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Fireguard Destroyer"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
	...
	public class NeutralBrmTest
	{
		...
		public void DragonkinSorcerer_BRM_020()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			var testCard = (Character) Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Dragonkin Sorcerer"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
		...
		public void VolcanicDrake_BRM_025()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Volcanic Drake"));
		...
		public void Nefarian_BRM_030()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Nefarian"));
			Assert.Equal(5, game.CurrentPlayer.HandZone.Count);
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			Assert.Equal(6, game.CurrentPlayer.HandZone.Count);
		...
		public void Chromaggus_BRM_031()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Chromaggus"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
		...
		public void BlackwingTechnician_BRM_033()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Blackwing Technician"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard1));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Blackwing Technician"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard2));
