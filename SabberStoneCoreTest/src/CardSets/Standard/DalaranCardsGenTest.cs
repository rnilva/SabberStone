...
namespace SabberStoneCoreTest.CardSets.Standard
{
	...
	public class PaladinDalaranTest
	{
		...
		public void CallToAdventure_DAL_727()
		{
			...
			Playable drawnP = game.IdEntityDic[game.CurrentPlayer.LastCardDrawn];
	...
	public class PriestDalaranTest
	{
		...
		public void LazulsScheme_DAL_011()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Lazul's Scheme"));
			// 1
			game.EndTurn();
	...
	public class RogueDalaranTest
	{
		...
		public void HeistbaronTogwaggle_DAL_417()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable lackey = Generic.DrawCard(game.CurrentPlayer, Cards.FromId("DAL_615"));  // Goblin Lackey
		...
		public void Vendetta_DAL_716()
		{
			...
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Vendetta"));
	...
	public class WarlockDalaranTest
	{
		...
		public void ArchVillainRafaam_DAL_422()
		{
			...
			ReadOnlySpan<Playable> span = game.CurrentPlayer.HandZone.GetSpan();
		...
		public void RafaamsScheme_DAL_007()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Rafaam's Scheme"));
			game.EndTurn();
			game.EndTurn();
			game.EndTurn();
			game.EndTurn();
	...
	public class NeutralDalaranTest
	{
		...
		public void Batterhead_DAL_592()
		{
			...
			for (int i = game.CurrentOpponent.BoardZone.Count - 1; i >= 0; --i)
			{
				testCard.Attack(game.CurrentOpponent.BoardZone[i]);
			}
		...
		public void JepettoJoybuzz_DAL_752()
		{
			...
			Assert.Equal(6, game.CurrentPlayer.HandZone.Count);
			Playable[] drawnCards = game.CurrentPlayer.HandZone.Skip(4).ToArray();
		...
		public void MagicCarpet_DAL_773()
		{
			...
			MinionInPlay target = (MinionInPlay) game.ProcessCard<Minion>((Minion)game.CurrentPlayer.HandZone.Last());
			Assert.Equal(target.Card.ATK + 1, target.AttackDamage);
			Assert.True(target.AttackableByRush);

			MinionInPlay target2 = (MinionInPlay) game.ProcessCard<Minion>((Minion) game.CurrentPlayer.HandZone[0]);
