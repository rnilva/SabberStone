...
namespace SabberStoneCoreTest.CardSets.Standard
{
	...
	public class DruidTrollTest
	{
		...
		public void PredatoryInstincts_TRL_244()
		{
			...
			Playable drawn = game.IdEntityDic[game.CurrentPlayer.LastCardDrawn];
	...
	public class HunterTrollTest
	{
		...
		public void RevengeOfTheWild_TRL_566()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Revenge of the Wild"));
	...
	public class MageTrollTest
	{
		...
		public void DaringFireEater_TRL_390()
		{
			...
			game.EndTurn();
			Assert.Equal(0, game.CurrentOpponent.Hero.HeroPowerDamage);
	...
	public class PaladinTrollTest
	{
		...
		public void ShirvallahTheTiger_TRL_300()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Shirvallah, the Tiger"));
	...
	public class PriestTrollTest
	{
		...
		public void SurrenderToMadness_TRL_500()
		{
			...
			foreach (Playable p in game.CurrentPlayer.DeckZone)
				if (p is Minion m)
				{
	...
	public class RogueTrollTest
	{
		...
		public void GurubashiHypemon_TRL_077()
		{
			...
			foreach (Playable p in game.CurrentPlayer.SetasideZone)
		...
		public void CaptainHooktusk_TRL_126()
		{
			...
			Assert.Equal(4, game.CurrentPlayer.BoardZone.Count);
			List<MinionInPlay> summoned = game.CurrentPlayer.BoardZone.Skip(1).ToList();
	...
	public class NeutralTrollTest
	{
		...
		public void Griftah_TRL_096()
		{
			...
			Playable chosen1 = game.ChooseNthChoice(1);
			Playable chosen2 = game.ChooseNthChoice(1);
		...
		public void Shieldbreaker_TRL_524()
		{
			...
			MinionInPlay taunter = game.ProcessCard<MinionInPlay>("Shieldbearer");

			game.EndTurn();

			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Shieldbreaker"));
