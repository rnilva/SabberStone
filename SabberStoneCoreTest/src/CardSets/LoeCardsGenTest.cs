...
namespace SabberStoneCoreTest.CardSets
{
	...
	public class DruidLoeTest
	{
		...
		public void RavenIdol_LOE_115()
		{
			...
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Raven Idol"));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Raven Idol"));
		...
		public void MountedRaptor_LOE_050()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			var testCard = (Character) Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Mounted Raptor"));
		...
		public void JungleMoonkin_LOE_051()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Jungle Moonkin"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
	...
	public class HunterLoeTest
	{
		...
		public void DartTrap_LOE_021()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Dart Trap"));
		...
		public void ExplorersHat_LOE_105()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Explorer's Hat"));
		...
		public void DesertCamel_LOE_020()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Desert Camel"));
	...
	public class MageLoeTest
	{
		...
		public void ForgottenTorch_LOE_002()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Forgotten Torch"));
		...
		public void EtherealConjurer_LOE_003()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Ethereal Conjurer"));
		...
		public void AnimatedArmor_LOE_119()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Animated Armor"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
	...
	public class PaladinLoeTest
	{
		...
		public void AnyfinCanHappen_LOE_026()
		{
			...
			Playable minion2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Murloc Warleader"));
			Playable minion3 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Grimscale Oracle"));
			Playable minion4 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Bluegill Warrior"));
			...
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Anyfin Can Happen"));
			game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard1));
			Assert.Equal(4, game.CurrentPlayer.BoardZone.Count);
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable spell2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Flamestrike"));
			game.Process(PlayCardTask.Spell(game.CurrentPlayer, spell2));
			Assert.Equal(0, game.CurrentPlayer.BoardZone.Count);
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Anyfin Can Happen"));
		...
		public void SacredTrial_LOE_027()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Sacred Trial"));
			game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			...
			Playable minion4 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Murloc Raider"));
		...
		public void KeeperOfUldaman_LOE_017()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Keeper of Uldaman"));
	...
	public class PriestLoeTest
	{
		...
		public void Entomb_LOE_104()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Entomb"));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable minion = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Bluegill Warrior"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
		...
		public void ExcavatedEvil_LOE_111()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Excavated Evil"));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable minion = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Bluegill Warrior"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
	...
	public class RogueLoeTest
	{
		...
		public void PitSnake_LOE_010()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Pit Snake"));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Pit Snake"));
		...
		public void TombPillager_LOE_012()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Tomb Pillager"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable spell = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Fireball"));
			Assert.Equal(4, game.CurrentOpponent.HandZone.Count);
			game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell, (Character) testCard));
			Assert.Equal(5, game.CurrentOpponent.HandZone.Count);
		}
		...
		public void UnearthedRaptor_LOE_019()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Unearthed Raptor"));
			Playable minion = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Loot Hoarder"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion));
			game.Process(PlayCardTask.MinionTarget(game.CurrentPlayer, testCard, (Character)minion));
	...
	public class ShamanLoeTest
	{
		...
		public void EveryfinIsAwesome_LOE_113()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Everyfin is Awesome"));
		...
		public void RumblingElemental_LOE_016()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Rumbling Elemental"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			Playable minion1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Murloc Raider"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion1));
		...
		public void TunnelTrogg_LOE_018()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Tunnel Trogg"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			...
			Playable minion2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Dust Devil"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion2));
	...
	public class WarlockLoeTest
	{
		...
		public void CurseOfRafaam_LOE_007()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Curse of Rafaam"));
			game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
		...
		public void ReliquarySeeker_LOE_116()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Reliquary Seeker"));
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Reliquary Seeker"));
			Playable minion1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stonetusk Boar"));
			Playable minion2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Stonetusk Boar"));
			...
			Playable minion5 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Murloc Raider"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion1));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion2));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion3));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion4));
	...
	public class WarriorLoeTest
	{
		...
		public void CursedBlade_LOE_118()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Cursed Blade"));
			game.Process(PlayCardTask.Spell(game.CurrentPlayer, testCard));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable spell = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Fireball"));
			game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell, game.CurrentOpponent.Hero));
	...
	public class NeutralLoeTest
	{
		...
		public void RenoJackson_LOE_011()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable minion = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Alexstrasza"));
			...
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Reno Jackson"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard1));
			...
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Reno Jackson"));
		...
		public void NagaSeaWitch_LOE_038()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Naga Sea Witch"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
		...
		public void GorillabotA3_LOE_039()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Gorillabot A-3"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard1));
			Assert.True(game.CurrentPlayer.Choice == null);
			Playable testCard2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Gorillabot A-3"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard2));
			Assert.True(game.CurrentPlayer.Choice != null);
		}
		...
		public void SirFinleyMrrgglton_LOE_076()
		{
			...
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Sir Finley Mrrgglton"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
		...
		public void BrannBronzebeard_LOE_077()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Brann Bronzebeard"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			Assert.Equal(4, game.CurrentPlayer.HandZone.Count);
			Playable minion1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Azure Drake"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion1));
			Assert.Equal(6, game.CurrentPlayer.HandZone.Count);
			game.CurrentPlayer.UsedMana = 0;
		...
		public void SummoningStone_LOE_086()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Summoning Stone"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			Playable spell1 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Frostbolt"));
			game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell1, game.CurrentOpponent.Hero));
			Assert.Equal(2, game.CurrentPlayer.BoardZone.Count);
			Assert.Equal(spell1.Card.Cost, game.CurrentPlayer.BoardZone[1].Card.Cost);
			Playable minion2 = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Sorcerer's Apprentice"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion2));
		...
		public void WobblingRunts_LOE_089()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Wobbling Runts"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			Playable minion = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Knife Juggler"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, minion));
			game.Process(EndTurnTask.Any(game.CurrentPlayer));
			Playable spell = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Fireball"));
			game.Process(PlayCardTask.SpellTarget(game.CurrentPlayer, spell, (Character) testCard));
		...
		public void EerieStatue_LOE_107()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Eerie Statue"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
		...
		public void AncientShade_LOE_110()
		{
			...
			game.Player1.BaseMana = 10;
			game.Player2.BaseMana = 10;
			Playable testCard = Generic.DrawCard(game.CurrentPlayer, Cards.FromName("Ancient Shade"));
			game.Process(PlayCardTask.Minion(game.CurrentPlayer, testCard));
			game.EndTurn();
			game.EndTurn();
